...
start: geometry.o converter.o package.o battleobjects.o interface.o parser.o main.o
	$(COMPILLER) $(FLAGS) -o sea-battle geometry.o converter.o package.o battleobjects.o interface.o parser.o main.o
